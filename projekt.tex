...
\projectinfo{
  ...
  title.cs={Implementace transportní architektury pro datová centra NDP pomocí XDP},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Implementation of the NDP Data-Center Transport Architecture Using XDP}, % název práce v angličtině / thesis title in english
